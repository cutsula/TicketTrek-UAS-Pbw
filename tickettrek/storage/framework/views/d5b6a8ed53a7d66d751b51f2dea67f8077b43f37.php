...
<head>
    ...
    <title>Properti SRD - Admin</title>
    ...
    <div id="wrapper">
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #764ca3;">
            <a class="sidebar-brand d-flex align-items-center justify-content-center text-white"
                ...
                <div class="sidebar-brand-text mx-3">Properti SRD</sup></div>
            </a>
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo e(url('admin/kategori')); ?>">
                    <i class="fas fa-fw fa-list text-white"></i>
                    <span>Kategori</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo e(url('admin/properti')); ?>">
                    <i class="fas fa-fw fa-pen text-white"></i>
                    <span>Properti</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo e(url('admin/pembelian')); ?>">
                    <i class="fas fa-fw fa-home text-white"></i>
                    <span>Transaksi</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo e(url('admin/pengguna')); ?>">
...
<?php /**PATH D:\Laravel Project\propertilaravel\resources\views/admin/templates/index.blade.php ENDPATH**/ ?>