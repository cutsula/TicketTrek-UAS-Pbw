...
<?php $__env->startSection('page-content'); ?>
    <div class="hero-wrap" style="background-image: url('<?php echo e(asset('assets/home/images/bgwisata(1).jpg')); ?>');"
            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-8 ftco-animate d-flex align-items-end">
                    <div class="text w-100 text-center">
                        ...
                        <p><a href="<?php echo e(url('home/wisata')); ?>" class="btn btn-danger py-2 px-4">Daftar Wisata</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center">
                    <img src="<?php echo e(asset('assets/home/images/about.png')); ?>" width="100%" style="border-radius: 10px">
                </div>
...
<?php echo $__env->make('home.templates.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cutsula/Downloads/tickettrek/resources/views/home/index.blade.php ENDPATH**/ ?>