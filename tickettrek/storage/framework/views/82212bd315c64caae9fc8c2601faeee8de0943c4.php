...
<nav class="navbar navbar-expand-lg navbar-danger ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar"
    ...
    <div class="container">
        <a class="navbar-brand text-white" href="<?php echo e(url('home')); ?>"> <img src="<?php echo e(asset('foto/logo.png')); ?>"
                width="30px" style="border-radius: 10px;">&nbsp; Properti SRD</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="<?php echo e(url('home/properti')); ?>"
                        class="nav-link text-light">Properti</a>
                </li>
                <li class="nav-item active dropdown">
                    <a class="nav-link dropdown-toggle text-light" href="#" id="dropdown03" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">Kategori</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown03">
                        <?php
                            $datakategori = DB::table('kategori')->get();
                        ?>
                        <?php $__currentLoopData = $datakategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(url('home/kategori/' . $value->idkategori)); ?>"
                                class="dropdown-item"><?php echo e($value->namakategori); ?></a>
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><span class="icon fa fa-instagram"></span><span
                                    class="text">propertisrd@gmail.com</span>
                            </li>
...
<?php /**PATH D:\Laravel Project\propertilaravel\resources\views/home/templates/index.blade.php ENDPATH**/ ?>